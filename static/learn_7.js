$(document).ready(function(){
  ...
  // Create arrow from thyme to pan
  let arrow_thyme = $("<img>");
  arrow_thyme.attr("src", actions["arrow"]["label"]["image"]);
  arrow_thyme.attr("alt", "thyme arrow");
  $(arrow_thyme).addClass("arrow-thyme-style");
  $("#arrow-thyme").append(arrow_thyme);

  // Create arrow from garlic to pan
  let arrow_garlic = $("<img>");
  arrow_garlic.attr("src", actions["arrow"]["label"]["image"]);
  arrow_garlic.attr("alt", "garlic arrow");
  $(arrow_garlic).addClass("arrow-garlic-style");
  $("#arrow-garlic").append(arrow_garlic);

  // Create arrow from butter to pan
  let arrow_butter = $("<img>");
  arrow_butter.attr("src", actions["arrow"]["label"]["image"]);
  arrow_butter.attr("alt", "butter arrow");
